...
- Easy
- Machine
permalink: /2025/07/HTB/Artificial
img: 2025/07/Artificial/Artificial.png
---
...
![Website](/assets/images/2025/07/Artificial/Website.png "Website")

The site talked about building and testing AI models.

There was also some code that showed how to build a model. 

![Example Code](/assets/images/2025/07/Artificial/ExampleCode.png "Example Code")
...
![Register](/assets/images/2025/07/Artificial/Register.png "Register")

Once connected, I was presented with a form to upload AI models.

![Connected](/assets/images/2025/07/Artificial/Connected.png "Connected")
...
![Uploaded Model](/assets/images/2025/07/Artificial/UploadedModel.png "Uploaded Model")

And I clicked on 'View Predictions' to see if I would get the result of the `ls` command.

![Model Predictions](/assets/images/2025/07/Artificial/ModelPredictions.png "Model Predictions")
...
![Backrest Login](/assets/images/2025/07/Artificial/BackrestLogin.png "Backrest Login")
...
![Backrest Logged In](/assets/images/2025/07/Artificial/BackrestLogedIn.png "Backrest Logged In")

I tried creating a backup plan. It required a repository, so I created one using a local path.

![Add Restic Repository](/assets/images/2025/07/Artificial/AddResticRepository.png "Add Restic Repository")

Then I created a plan that used the new repository.

![Create Backup Plan](/assets/images/2025/07/Artificial/CreateBackupPlan.png "Create Backup Plan")

I added a command hook to the plan that copied `/bin/bash` in `/tmp` and made it `suid`.

![Add Hook](/assets/images/2025/07/Artificial/AddHook.png "Add Hook")

I ran the backup.

![Backup Now](/assets/images/2025/07/Artificial/BackupNow.png "Backup Now")
